...
def create_parser():
    ...
    parser.add_argument('--path_tables', type=str, default='/Users/af1tang/Dropbox/MIT/local_mimic/tables',
                        help='Path to the original MIMIC-III Tables.')
    parser.add_argument('--path_views', type=str, default='/Users/af1tang/Dropbox/MIT/local_mimic/views',
                        help='Path to View tables from MIMIC-III cookbook.')
    parser.add_argument('--path_save', type=str, default='/Users/af1tang/Desktop/tmp',
